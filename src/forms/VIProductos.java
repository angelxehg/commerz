 ...
 * @author angel
 */
public class VIProductos extends javax.swing.JInternalFrame {
    ...
    private void BusquedaDatos() {
        List<Object[]> R = Productos.Buscar(Busqueda, Desde, Hasta);
        if (R != null) {
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        ProductosAgregar Agregar = new ProductosAgregar();
        Agregar.setVisible(true);
    }//GEN-LAST:event_BtnAgregarActionPerformed

    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        if (IDSeleccionado > 0) {
            ProductosEditar Editar = new ProductosEditar();
            Editar.CargarValores(IDSeleccionado);
            Editar.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Primero seleccione un producto a editar");
        }
    }//GEN-LAST:event_BtnEditarActionPerformed

    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        if (IDSeleccionado > 0) {
            Productos.Eliminar(IDSeleccionado);
        } else {
